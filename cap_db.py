...
for f in dict_data['features'] :
     ...
     if project['PROJECTNAME'] is None or project['APPROVALDATE'] is None : continue
     ...
     rname = kl[11:] #list of strings
     if project['SMIP'] == -1 : grant = 0
     elif project['GARP'] == -1 : grant = 1
     else : grant = None

     for i in range(len(rname)) :
          rname[i] = (rname[i],) # make it into a list of tuples for executemany argument
